...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a4:	45050513          	addi	a0,a0,1104 # 7f0 <digits>
 3a8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 470:	384b8b93          	addi	s7,s7,900 # 7f0 <digits>
 ...
 5b0:	23c90913          	addi	s2,s2,572 # 7e8 <malloc+0xf6>
        while(*s != 0){
...
free(void *ap)
{
 ...
 678:	1947b783          	ld	a5,404(a5) # 808 <freep>
 ...
 6a6:	00e6ea63          	bltu	a3,a4,6ba <free+0x50>
{
 ...
 6e8:	12f73223          	sd	a5,292(a4) # 808 <freep>
}
 6ec:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 71a:	0f253503          	ld	a0,242(a0) # 808 <freep>
 ...
 742:	0ca90913          	addi	s2,s2,202 # 808 <freep>
  if(p == (char*)-1)
 746:	5afd                	li	s5,-1
 748:	a88d                	j	7ba <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 74a:	00000797          	auipc	a5,0x0
 74e:	0c678793          	addi	a5,a5,198 # 810 <base>
 752:	00000717          	auipc	a4,0x0
 756:	0af73b23          	sd	a5,182(a4) # 808 <freep>
 75a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 77c:	08a73823          	sd	a0,144(a4) # 808 <freep>
      return (void*)(p + 1);
